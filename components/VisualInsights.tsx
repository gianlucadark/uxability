    ...
    return (
        <div className="space-y-6">
            <div className="flex items-center gap-3">
                ...
                <h3 className="text-xl md:text-2xl font-bold text-white">Visual Rendering</h3>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
                ...
                <div className="lg:col-span-8 flex flex-col gap-4">
                    <div className="card overflow-hidden">
                        <div className="flex items-center justify-between px-6 py-4 border-b border-[#333] bg-[#111]">
                            <div className="flex items-center gap-2">
                                <span className="text-xs font-bold text-[#888888] uppercase tracking-widest text-[10px]">Preview finale Desktop</span>
                            </div>
                        ...
                        <div className="p-4">
                            <div className="relative aspect-video rounded-xl overflow-hidden border border-[#333] bg-[#000]">
                                <img
                                    src={screenshot}
                    ...
                    <div className="card p-4 flex items-start gap-3">
                        <Info size={18} className="text-[#888888] shrink-0 mt-0.5" />
                ...
                <div className="lg:col-span-4">
                    <div className="card p-6 flex flex-col h-full space-y-6">
                        <div className="flex items-center gap-2 mb-2">
                            <PlayCircle size={18} className="text-[#888888]" />
                            <span className="text-xs font-bold text-[#888888] uppercase tracking-widest text-[10px]">Time-lapse Caricamento</span>
                        </div>
                        ...
                        <div className="flex flex-col gap-4 overflow-y-auto max-h-[500px] pr-2 custom-scrollbar">
                            {thumbnails?.map((thumb, i) => (
                                <div
                                    key={i}
                                    className="flex flex-row items-center gap-4 py-3 border-b border-[#222] last:border-none"
                                >
                                    <div className="relative w-24 h-16 flex-shrink-0 rounded-lg overflow-hidden border border-[#333] bg-[#111]">
                                        <img src={thumb.data} alt={`Frame ${i}`} className="w-full h-full object-cover" />
                                    </div>
                                    <div className="flex flex-col">
                                        <p className="text-sm font-bold text-white tracking-tight leading-none mb-1">{thumb.timestamp}ms</p>
                                        <p className="text-[10px] uppercase font-bold text-[#555]">Snapshot {i + 1}</p>
                                    </div>
                                </div>
                            ))}
                        </div>

                        <div className="pt-4 mt-auto border-t border-[#222] text-[10px] text-[#555] leading-snug italic">
