export const translations = {
    it: {
        ...
        aeo_ai_role_high_weight: "Peso AI sui segnali qualitativi: Q&A, paragrafi estraibili, definizioni, risposta diretta, citazioni, autore e data.",
        aeo_ai_role_low_weight: "Peso AI sui segnali tecnici: schema, heading, semantica HTML, meta description, llms.txt e FAQ schema.",
    ...
    en: {
        ...
        aeo_ai_role_high_weight: "AI weight on qualitative signals: Q&A, extractable paragraphs, definitions, direct answers, citations, author, and date.",
        aeo_ai_role_low_weight: "AI weight on technical signals: schema, headings, semantic HTML, meta description, llms.txt, and FAQ schema.",
